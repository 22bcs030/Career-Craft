...
// For development mode, import the SimpleTodoPage
import SimpleTodoPage from "@/components/SimpleTodoPage";

// Check if we're in development mode
const isDevelopment = process.env.NODE_ENV === "development";

export default function TodoPage() {
  // In development mode, render SimpleTodoPage instead
  if (isDevelopment) {
    return <SimpleTodoPage />;
  }
  
  // Production mode code below
